const UNIPOOL_GDAO_ABI = [
    ...
    inputs: [
      {
        ...
        name: '_new_GDAO_TokenContractAddress',
        type: 'address'
      }
    ],
    name: 'set_new_GDAO_TokenContractAddress',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function'
  },
  {
    inputs: [
      {
        internalType: 'address',
        name: '_GDAO_TokenContractAddress',
        type: 'address'
      },
      {
...
export default UNIPOOL_GDAO_ABI;