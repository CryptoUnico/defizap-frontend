...
import Have from '../governate/have'
import Want from '../governate/want'
import Sending from '../governate/sending'
import ConversionRatios from '../governate/conversionRatios'
...
export default withRouter(withStyles(styles)(Zap));
